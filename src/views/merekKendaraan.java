 ...
 */
public class merekKendaraan extends javax.swing.JFrame {
    ...
    /**
     * Creates new form merkKendaraan
     */
    public merekKendaraan() {
        initComponents();
        kosong();
        aktif();
        datatable();
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        String sql = "insert into merekKendaraan values (?,?,?)";
        try {
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        id.setEditable(true);
        try {
            String sql = "update merekKendaraan set nama=?,keterangan=? where idMerek ='" + id.getText() + "'  ";
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from merekKendaraan where idMerek ='" + id.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(merekKendaraan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new merekKendaraan().setVisible(true);
            }
        });
    }
    ...
    private void datatable() {
        ...
        try {
            String sql = "SELECT * FROM merekKendaraan where idMerek like '%" + cariitem + "%' or nama like '%" + cariitem + "%' order by idMerek asc ";
